                        ...
                        <div className="container-xl">
                                    ...
                                    <Reveal animation="fade-up" delay={0.1}>
                                        <div className="footer_1i">
                                            ...
                                            <div className="row footer_1ism">
                                                ...
                                                <h6 className="mt-2 col-md-12 col-12"><Link className="text-light" href="/destinations"> All Destinations</Link></h6>
                                    ...
                                    <Reveal animation="fade-up" delay={0.2}>
                                        <div className="footer_1i">
                                            ...
                                            <div className="row footer_1ism">
                                                ...
                                                <h6 className="mt-2 col-md-12 col-12"><Link className="text-light" href="/event"> Testimonials</Link></h6>
                                            </div>
                                        </div>
                                    </Reveal>
                                </div>
                            ...
                            <div className="row footer_newsletter py-4 py-lg-5 align-items-center mx-0" style={{ borderTop: '1px solid #224e7c', borderBottom: '1px solid #224e7c', marginTop: '40px' }}>
                                <div className="col-lg-3 mb-4 mb-lg-0">
                                    <h3 className="text-white fw-bold mb-1" style={{ fontSize: '26px' }}>Get the latest updates & offers</h3>
                                </div>
                            ...
                            <div className="row footer_3 mt-3 pt-3">
                                <div className="col-md-9">
                                    <div className="footer_3l pt-2">
                                        ...
                                        <p className="mb-0 mt-1 small" style={{ color: 'rgba(255,255,255,0.6)' }}>
                                            <a href="https://infinityconsultants.com" target="_blank" rel="noreferrer" className="text-decoration-none hvr-col" style={{ color: 'inherit' }}>infinityconsultants.com</a>
                                            <span className="mx-2">|</span>
                                            <a href="https://infinityoverseas.pk" target="_blank" rel="noreferrer" className="text-decoration-none hvr-col" style={{ color: 'inherit' }}>infinityoverseas.pk</a>
                                        </p>
                                    </div>
                                </div>
                                <div className="col-md-3">
                                    <div className="footer_3r text-end">
                                        <ul className="social-network social-circle mb-0">
                                            ...
                                            <li className="mx-1"><Magnetic><a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="icoLinkedin" title="LinkedIn" aria-label="Follow us on LinkedIn"><i className="fa fa-linkedin"></i></a></Magnetic></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
