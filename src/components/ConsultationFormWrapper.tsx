    ...
    return (
        <div className="p-4 p-md-5 bg-white h-100">
            <div className="mb-5 text-center position-relative">
                <span className="d-block col_green fw-bold text-uppercase ls-2 mb-2">Let's Talk</span>
                <h2 className="fw-bold display-6 mb-0 text-gradient-oran uppercase">GET FREE CONSULTATION</h2>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="row g-4">
                        ...
                        <div className="col-md-6">
                            ...
                            <select name="lastQualification" className="form-select px-3 py-2 bg_white border-secondary rounded-3 shadow-none text-muted" value={form.lastQualification} onChange={handleChange} required>
                        ...
                        <div className="col-md-6">
                            ...
                            <select name="preferredCountry" className="form-select px-3 py-2 bg_white border-secondary rounded-3 shadow-none text-muted" value={form.preferredCountry} onChange={handleChange} required>
                                <option value="">Select</option>
                        ...
                        <div className="col-md-6">
                            ...
                            <select name="fieldOfInterest" className="form-select px-3 py-2 bg_white border-secondary rounded-3 shadow-none text-muted" value={form.fieldOfInterest} onChange={handleChange}>
                                <option value="">Select</option>
                        ...
                        <div className="col-md-6">
                            ...
                            <select name="languageTest" className="form-select px-3 py-2 bg_white border-secondary rounded-3 shadow-none text-muted" value={form.languageTest} onChange={handleChange} required>
                                <option value="">Select</option>
                        ...
                        <div className="col-md-6">
                            ...
                            <select name="modeOfCounselling" className="form-select px-3 py-2 bg_white border-secondary rounded-3 shadow-none text-muted" value={form.modeOfCounselling} onChange={handleChange} required>
                                <option value="">Select</option>
                        ...
                        <div className="col-md-6">
                            ...
                            <select name="modeOfFunding" className="form-select px-3 py-2 bg_white border-secondary rounded-3 shadow-none text-muted" value={form.modeOfFunding} onChange={handleChange} required>
                                <option value="">Select</option>
