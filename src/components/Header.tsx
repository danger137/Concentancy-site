...
const servicesDropdownLinks = [
  ...
  { href: "/services/pre-departure", label: "Pre-Departure Guidance", icon: "fa-plane-departure" },
];


const navLinks = [
  { href: "/testimonials", label: "Success Stories" },
  { href: "/event", label: "Events/Testimonials" },
      ...
      <div className="site-header__top d-none d-lg-block">
        <div className="site-navbar__inner py-1">
          <div className="d-flex gap-4 small text-white">
            <a href={`mailto:${settings.email}`} className="text-white text-decoration-none hover-oran">
              <i className="fa fa-envelope col_green me-2"></i> {settings.email}
            </a>
          </div>
          ...
          <div className={`site-navbar__menu ${menuOpen ? 'site-navbar__menu--open' : ''}`}>
            <ul className="site-navbar__nav">
              ...
              <li className="site-navbar__nav-item">
                <Link
                  href="/why-choose-us"
                  className={`site-navbar__nav-link ${isActive('/why-choose-us') ? 'site-navbar__nav-link--active' : ''}`}
